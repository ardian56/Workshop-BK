            ...
            <div class="bg-gray overflow-hidden shadow-xl sm:rounded-lg p-8">
                <form action="{{ route('dokter.memeriksa.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" name="tgl_periksa" id="tgl_periksa" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ date('Y-m-d') }}" required>
                        @error('tgl_periksa')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="catatan" id="catatan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32" required>{{ old('catatan') }}</textarea>
                        @error('catatan')
                            <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            // Using a slight delay to ensure DOM updates before recalculating on button clicks
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            obatList.addEventListener('click', function(e) {
                                if (e.target.classList.contains('add-obat')) {
                                    ...
                                    btn.classList.remove('bg-green-500', 'hover:bg-green-700', 'add-obat');
