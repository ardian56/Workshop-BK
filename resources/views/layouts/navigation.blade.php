    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->role == 'dokter')
                ...
                <x-responsive-nav-link :href="route('dokter.jadwalperiksa.index')" :active="request()->routeIs('dokter.jadwalperiksa.index')">
                    {{ __('Jadwal Periksa') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->role == 'pasien')
                ...
                <x-responsive-nav-link :href="route('pasien.janjiperiksa.index')" :active="request()->routeIs('pasien.janjiperiksa.index')">
                    {{ __('Janji Periksa') }}
                </x-responsive-nav-link>
            @endif
        </div>
