            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            {{-- FIX 2: Check if periksa is not null --}}
                                            @if ($janjiPeriksa->periksa)
                    ...
                    <div class="mb-4 border-2 card">
                        ...
                        <div class="card-body">
                            {{-- Check for periksa and its detailPeriksas with eager loaded obat relationship --}}
                            @if ($janjiPeriksa->periksa && $janjiPeriksa->periksa->detailPeriksa && $janjiPeriksa->periksa->detailPeriksa->isNotEmpty())
                                <ul class="list-group list-group-flush">
                                    @foreach ($janjiPeriksa->periksa->detailPeriksa as $detailPeriksa)
                                        @if ($detailPeriksa->obat)
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold fs-5 text-primary">
                                    {{-- FIX 4: Check if periksa is not null --}}
                                    @if ($janjiPeriksa->periksa)
                    ...
                    <div class="mt-4">
                        <a href="{{ route('pasien.riwayatperiksa.index') }}" class="btn btn-secondary">
